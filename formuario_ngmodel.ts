                                ...
                                <div class="widget-chart">
                                    <div class="widget-chart-content">
                                        ...
                                        <div class="widget-subheading pt-2">
                                            Questões de aceitação de crédito
                                        </div>
                                ...
                                <div class="widget-content-left">
                                    <div class="btn-group">
                                        <a data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"
                                            class="p-0 btn">
                                            <img width="42" class="rounded-circle" src="assets/images/avatars/13.png"
                                                alt>
                                        ...
                                        <div tabindex="-1" role="menu" aria-hidden="true"
                                                        ...
                                                        <div class="widget-content p-0">
                                                            <div class="widget-content-wrapper">
                                                                ...
                                                                <div class="widget-content-right mr-2">
                                                                    <button
                                                                        class="btn-pill btn-shadow btn-shine btn btn-focus">Sair</button>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="scroll-area-xs" style="height: 150px;">
                                                <div class="scrollbar-container ps">
                                                    <ul class="nav flex-column">
                                                        <li class="nav-item-header nav-item">Actividade</li>
                                                        <li class="nav-item">
                                                        ...
                                                        <li class="nav-item">
                                                            <a href="javascript:void(0);" class="nav-link">
                                                                Configurações
                                                                <div class="ml-auto badge badge-success">Nova</div>
                                                            </a>
                                                        </li>
                                                        <li class="nav-item">
                                                            <a href="javascript:void(0);" class="nav-link">
                ...
                <div class="scrollbar-sidebar">
                    <div class="app-sidebar__inner">
                        <ul class="vertical-nav-menu">
                            ...
                            <li class="app-sidebar__heading">Gestão Usuários</li>
                            <li>
                    ...
                    <div class="app-page-title">
                        <div class="page-title-wrapper">
                            <div class="page-title-heading">
                                ...
                                <div>
                                    Formulário - Crédito Fácil
                                    <div class="page-title-subheading">
                                        Diminuir
                                        Não importa a quantidade de dados
                                        Crédito Fácil.
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="tab-content">
                        <div class="tab-pane tabs-animation fade show active" id="tab-content-0" role="tabpanel">
                            <div class="main-card mb-3 card">
                                <div class="card-body">
                                    <h5 class="card-title">Aprendizado Máquina</h5>
                                    <form class="">

                                        <!-- Campos do modelo de empréstimo -->

                                        <div class="form-row">
                                            <div class="col-md-6">
                                                <div class="position-relative form-group">
                                                    <label for="numeroConta" class>Número da Conta</label>
                                                    <input [(ngModel)]="emprestimo.numero_conta" id="numeroConta"
                                                        placeholder="Número da Conta" type="text" class="form-control">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="position-relative form-group">
                                                    <label for="nomeCompleto" class>Nome Completo</label>
                                                    <input [(ngModel)]="emprestimo.nome_completo" id="nomeCompleto"
                                                        placeholder="Nome Completo" type="text" class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-row">
                                            <div class="col-md-6">
                                                <div class="position-relative form-group">
                                                    ...
                                                    <select [(ngModel)]="emprestimo.genero" id="genero"
                                                        class="form-control">
                                            ...
                                            <div class="col-md-6">
                                                <div class="position-relative form-group">
                                                    ...
                                                    <select [(ngModel)]="emprestimo.estado_civil" id="estadoCivil"
                                                        class="form-control">
                                                        <option value="Yes">Casado</option>
                                                        <option value="No">Solteiro</option>
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="position-relative form-group">
                                            <label for="dependentes" class>Dependentes</label>
                                            <select [(ngModel)]="emprestimo.dependentes" id="dependentes"
                                                class="form-control">
                                                <option value="No">Não</option>
                                                <option value="One">Um</option>
                                                <option value="Two">Dois</option>
                                                <option value="More than Two">Mais do que um</option>
                                            </select>
                                        </div>

                                        <div class="position-relative form-group">
                                            <label for="edu" class>Educação</label>
                                            <select [(ngModel)]="emprestimo.educacao" id="edu" class="form-control">
                                                <option value="Not Graduate">Não Graduado</option>
                                                <option value="Graduate">Graduado</option>
                                            </select>
                                        </div>

                                        <div class="position-relative form-group">
                                            <label for="emp" class>Emprego</label>
                                            <select [(ngModel)]="emprestimo.emprego" id="emp" class="form-control">
                                                <option value="Job">Trabalhador</option>
                                                <option value="Business">Empreendedor</option>
                                            </select>
                                        </div>

                                        <div class="position-relative form-group">
                                            <label for="dur" class>Duração do Empréstimo</label>
                                            <select [(ngModel)]="emprestimo.duracao_emprestimo" id="dur"
                                                class="form-control">
                                                <option value="2 Math">2 Mêses</option>
                                                <option value="6 Math">6 Mêses</option>
                                                <option value="8 Math">8 Mêses</option>
                                                <option value="1 Year">1 Ano</option>
                                                <option value="16 Math">16 Mês</option>
                                            </select>
                                        </div>

                                        <div class="position-relative form-group">
                                            <label for="prop" class>Propriedade/Local</label>
                                            <select [(ngModel)]="emprestimo.propriedade" id="prop" class="form-control">
                                                <option value="Rural">Rural</option>
                                                <option value="Semi-Urban">Semi-Urbano</option>
                                                <option value="Urban">Urbano</option>
                                            </select>
                                        </div>

                                        <div class="position-relative form-group">
                                            <label for="cred" class>Crédito</label>
                                            <select [(ngModel)]="emprestimo.credito" id="cred" class="form-control">
                                                <option value="Between 300 to 500">Entre Kzs 300.000,00 a Kzs 500.000,00
                                                </option>
                                                <option value="Above 500">Àcima de 500.000,00 Kzs</option>
                                            </select>
                                        </div>
                                        ...
                                        <div class="form-row">
                                            <div class="col-md-6">
                                                <div class="position-relative form-group">
                                                    <label for="rendaMensalRequerente" class>Renda Mensal do
                                                        Requerente</label>
                                                    <input [(ngModel)]="emprestimo.renda_mensal_requerente"
                                                        id="rendaMensalRequerente"
                                                        placeholder="Renda Mensal do Requerente" type="text"
                                                        class="form-control">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="position-relative form-group">
                                                    <label for="rendaMensalCoRequerente" class>Renda Mensal do
                                                        Co-Requerente</label>
                                                    <input [(ngModel)]="emprestimo.renda_mensal_co_requerente"
                                                        id="rendaMensalCoRequerente"
                                                        placeholder="Renda Mensal do Co-Requerente" type="text"
                                                        class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="position-relative form-group">
                                            <label for="valorEmprestimo" class>Valor do Empréstimo</label>
                                            <input [(ngModel)]="emprestimo.valor_emprestimo" id="valorEmprestimo"
                                                placeholder="Valor do Empréstimo" type="number" class="form-control">
                                        </div>

                                        <div class="position-relative form-group">
                                            <label for="tipoCredito" class>Tipo de Crédito</label>
                                            <select [(ngModel)]="emprestimo.tipo_credito" id="tipoCredito"
                                                class="form-control">
                                        ...
                                        <div class="position-relative form-group">
                                            ...
                                            <input [(ngModel)]="emprestimo.email" id="email" placeholder="E-mail"
                                                type="email" class="form-control">
                                        </div>

                                        <button class="mt-2 btn btn-primary" [disabled]="isCreating" (click)="criarEmprestimo()">
                                            {{ isCreating ? 'Analisando os dados...' : 'Calcular' }}
                                        </button>
                                ...
                                <div class="card-body">
                                    ...
                                    <form class>
                                        ...
                                        <div class="position-relative row form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <select multiple name="selectMulti" id="exampleSelectMulti"
                                        ...
                                        <div class="position-relative row form-group">
                                            ...
                                            <div class="col-sm-10">
                                                ...
                                                <small class="form-text text-muted">
                                                    ...
                                                    for the above input. It's
                                                    a bit lighter and easily
                                                    wraps to a new line.
                                                </small>
                                            </div>
                                        </div>
                                        <fieldset class="position-relative row form-group">
                                            ...
                                            <div class="col-sm-10">
                                                ...
                                                <div class="position-relative form-check disabled">
                                                    <label class="form-check-label">
                                                        <input name="radio2" disabled type="radio"
                                                    ...
                                                    <div class="no-gutters row">
                                                        <div class="col-sm-6">
                                                            <button
                                                                ...
                                                                <i
                                                                    class="lnr-lighter text-dark opacity-7 btn-icon-wrapper mb-2"></i>
                                                                Automation
                                                            </button>
                                                        </div>
                                                        <div class="col-sm-6">
                                                            <button
                                                                ...
                                                                <i
                                                                    class="lnr-construction text-danger opacity-7 btn-icon-wrapper mb-2"></i>
                                                                Reports
                                                            </button>
                                                        </div>
                                                        <div class="col-sm-6">
                                                            <button
                                                                ...
                                                                <i
                                                                    class="lnr-bus text-success opacity-7 btn-icon-wrapper mb-2"></i>
                                                                Activity
                                                            </button>
                                                        </div>
                                                        <div class="col-sm-6">
                                                            <button
                                                                ...
                                                                <i
                                                                    class="lnr-gift text-focus opacity-7 btn-icon-wrapper mb-2"></i>
                                                                Settings
                                                            </button>
                                                        </div>
                                                    </div>
